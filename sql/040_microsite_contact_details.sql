-- 040_microsite_contact_details.sql
-- Adds phone, address, and hours -- rounds out the Contact section
-- beyond just an email link, matching what a real "Contact Information"
-- block needs. Deliberately NOT adding a contact form or social links
-- yet; no backend exists to receive form submissions, and social links
-- are being held for a later pass.
--
-- Run after: 039_microsite_focal_points.sql

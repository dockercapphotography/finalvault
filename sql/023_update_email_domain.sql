-- Migration 023: Update email sender/link domain to final-vault.app
--
-- Redefines move_signup_slot_booking and update_signup_slot_time (both last
-- modified in 022_fix_reschedule_side_effects.sql) to use the new domain for
-- ORGANIZER:mailto: calendar entries and the Resend 'from' address, as part
-- of the v1.5.6 domain migration from finalvault.dockercapphotography.com to
-- final-vault.app. No other logic changes.

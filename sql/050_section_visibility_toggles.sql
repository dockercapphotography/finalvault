-- 050_section_visibility_toggles.sql
-- Adds explicit show/hide toggles for About, Gallery, Testimonials,
-- and Contact -- matching the pattern show_pricing already established.
-- All default true so existing sites don't lose any sections when this
-- ships; visibility remains content-gated as before (a section with no
-- content still won't show), this just adds an explicit override on
-- top of that, same as Pricing already has.
--
-- Run after: 049_gallery_image_focus.sql

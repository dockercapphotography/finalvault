-- 041_microsite_social_links.sql
-- Exposes photographers.social_links (already populated via Account >
-- Social, already reused elsewhere e.g. questionnaire redirects) to the
-- public microsite RPC -- no new column needed on microsites, straight
-- reuse of existing account-level data, same pattern as logo_r2_key.
--
-- Run after: 040_microsite_contact_details.sql
